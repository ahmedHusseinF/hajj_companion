...
mapInit.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyCfXJ4DFcVAriFGCrObaWS0L_Un0nW2wu8&callback=initMap";
mapInit.async = true;
mapInit.defer = true;
...
function initMap() {
  ...
  function calculateAndDisplayRoute(directionsService, directionsDisplay) {
    ...
    directionsService.route({
      ...
      destination: {lat: user.location.latitude, lng: user.location.longitude},
      travelMode: 'WALKING'
